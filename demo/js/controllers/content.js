...
demoApplication.controller('ContentCtrl', ['$scope', '$eventEngine', '$fakeRepository', function ($scope, $eventEngine, $fakeRepository) {

    $fakeRepository.getItems(function (items) {
        $scope.items = items;
    });
